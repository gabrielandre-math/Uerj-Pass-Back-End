...
`), o = o.replace(/\\r/g, "\r")), r[i] = o;
    ...
    var Vf = {};
    tr(Vf, { DMMF: () => ut, Debug: () => N, Decimal: () => Pe, Extensions: () => ri, MetricsClient: () => Lr, PrismaClientInitializationError: () => T, PrismaClientKnownRequestError: () => z2, PrismaClientRustPanicError: () => le, PrismaClientUnknownRequestError: () => j, PrismaClientValidationError: () => Z, Public: () => ti, Sql: () => oe, createParam: () => Ra, defineDmmfProperty: () => Da, deserializeJsonResponse: () => Tr, deserializeRawResult: () => zn, dmmfToRuntimeDataModel: () => Zs, empty: () => La, getPrismaClient: () => gu, getRuntime: () => Vn, join: () => Na, makeStrictEnum: () => hu, makeTypedQueryFactory: () => _a, objectEnumValues: () => Cn, raw: () => eo, serializeJsonQuery: () => Nn, skip: () => _n, sqltag: () => ro, warnEnvConflicts: () => yu, warnOnce: () => st });
      ...
      schema: {
        ...
        response: {
          200: import_zod.z.object({
            event: import_zod.z.object({
              id: import_zod.z.string().uuid(),
              title: import_zod.z.string(),
              slug: import_zod.z.string(),
              details: import_zod.z.string().nullable(),
              maximumAttendees: import_zod.z.number().int().nullable(),
              attendeesAmount: import_zod.z.number().int()
            })
          })
        }
      }
