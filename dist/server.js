...
`), o = o.replace(/\\r/g, "\r")), r[i] = o;
    ...
    var Vf = {};
    tr(Vf, { DMMF: () => ut, Debug: () => N, Decimal: () => Pe, Extensions: () => ri, MetricsClient: () => Lr, PrismaClientInitializationError: () => T, PrismaClientKnownRequestError: () => z7, PrismaClientRustPanicError: () => le, PrismaClientUnknownRequestError: () => j, PrismaClientValidationError: () => Z, Public: () => ti, Sql: () => oe, createParam: () => Ra, defineDmmfProperty: () => Da, deserializeJsonResponse: () => Tr, deserializeRawResult: () => zn, dmmfToRuntimeDataModel: () => Zs, empty: () => La, getPrismaClient: () => gu, getRuntime: () => Vn, join: () => Na, makeStrictEnum: () => hu, makeTypedQueryFactory: () => _a, objectEnumValues: () => Cn, raw: () => eo, serializeJsonQuery: () => Nn, skip: () => _n, sqltag: () => ro, warnEnvConflicts: () => yu, warnOnce: () => st });
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    x(z7, "PrismaClientKnownRequestError");
...
`);
    ...
    function $r({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z7(cm(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new j(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function cm(e, r) {
      let t = e.message;
...
`;
    ...
    async function Ft(e, r) {
      ...
      if (n.type === "QueryEngineError") throw new z7(n.body.message, { code: n.body.error_code, clientVersion: r });
    ...
    var Gr = class {
      ...
      async transaction(r, t, n) {
        ...
        if (xf(a)) {
          ...
          throw l ? l.error : new z7(a.message, { code: a.error_code, clientVersion: this.config.clientVersion, meta: a.meta });
    ...
    var Zn = class {
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (l = wn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
          ...
          throw new z7(l, { code: r.code, clientVersion: this.client._clientVersion, meta: u, batchRequestIdx: r.batchRequestIdx });
        } else {
  ...
  "src/generated/prisma/index.js"(exports2) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\whitedesk\\Desktop\\uerj-pass\\src\\generated\\prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\whitedesk\\Desktop\\uerj-pass\\prisma\\schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
      ...
      "inlineSchemaHash": "27ce312dc90eee6ce51e1e245972b2506553e86cf647f84757277300231234f6",
      "copyEngine": true
    };
    var fs = require("fs");
    ...
    config.runtimeDataModel = JSON.parse('{"models":{"Event":{"dbName":"events","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"title","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"details","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"slug","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"maximumAttendees","dbName":"maximum_attendees","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Int","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"attendees","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Attendee","nativeType":null,"relationName":"AttendeeToEvent","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Attendee":{"dbName":"attendees","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"Int","nativeType":null,"default":{"name":"autoincrement","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"email","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","dbName":"created_at","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"eventId","dbName":"event_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"event","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Event","nativeType":null,"relationName":"AttendeeToEvent","relationFromFields":["eventId"],"relationToFields":["id"],"relationOnDelete":"Cascade","isGenerated":false,"isUpdatedAt":false},{"name":"checkIn","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"CheckIn","nativeType":null,"relationName":"AttendeeToCheckIn","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[["eventId","email"]],"uniqueIndexes":[{"name":null,"fields":["eventId","email"]}],"isGenerated":false},"CheckIn":{"dbName":"check_ins","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"Int","nativeType":null,"default":{"name":"autoincrement","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","dbName":"created_at","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"attendee","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Attendee","nativeType":null,"relationName":"AttendeeToCheckIn","relationFromFields":["attendeeId"],"relationToFields":["id"],"relationOnDelete":"Cascade","isGenerated":false,"isUpdatedAt":false},{"name":"attendeeId","dbName":"attendee_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"Int","nativeType":null,"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{},"types":{}}');
...
// src/routes/_erorrs/bad-request.ts
...
async function createEvent(app3) {
  app3.withTypeProvider().post(
    "/events",
    {
      schema: {
...
// src/routes/register-for-event.ts
function registerForEvent(app3) {
  app3.withTypeProvider().post(
    "/events/:eventId/attendees",
    {
      schema: {
        ...
        params: import_zod2.z.object({
          eventId: import_zod2.z.string().uuid()
        }),
        response: {
          201: import_zod2.z.object({
            attendeeId: import_zod2.z.number()
          })
        }
      }
    },
    async (request, reply) => {
      ...
      const attendeeFromEmail = await prisma2.attendee.findUnique({
        where: {
          eventId_email: {
            email,
            eventId
      ...
      const [event, amountOfAttendeesForEvent] = await Promise.all([
        prisma2.event.findUnique({
          where: { id: eventId }
        }),
        prisma2.attendee.count({
          where: { eventId }
        })
      ]);
      ...
      const attendee = await prisma2.attendee.create({
        data: {
          name,
          email,
          eventId
...
async function getEvent(app3) {
  app3.withTypeProvider().get(
    "/events/:eventId",
    {
      schema: {
        params: import_zod3.z.object({
          eventId: import_zod3.z.string().uuid()
        }),
        response: {
          200: import_zod3.z.object({
            event: import_zod3.z.object({
              id: import_zod3.z.string().uuid(),
              title: import_zod3.z.string(),
              slug: import_zod3.z.string(),
              details: import_zod3.z.string().nullable(),
              maximumAttendees: import_zod3.z.number().int().nullable(),
              attendeesAmount: import_zod3.z.number().int()
            })
          })
        }
      }
    ...
    async (request, reply) => {
      const { eventId } = request.params;
      const event = await prisma2.event.findUnique({
        select: {
          id: true,
          title: true,
          slug: true,
...
async function getAttendeeBadge(app3) {
  app3.withTypeProvider().get(
    ...
    async (request, reply) => {
      ...
      const attendee = await prisma2.attendee.findUnique({
        select: {
          name: true,
          email: true,
          event: {
...
async function checkIn(app3) {
  app3.withTypeProvider().get(
    "/attendees/:attendeeId/check-in",
    {
      schema: {
        params: import_zod5.z.object({
          attendeeId: import_zod5.z.coerce.number().int()
        }),
        response: {
          201: import_zod5.z.null()
        }
      }
    },
    async (request, reply) => {
      const { attendeeId } = request.params;
      const attendeeCheckIn = await prisma2.checkIn.findUnique({
        where: {
          attendeeId
        }
      });
...
async function getEventAttendees(app3) {
  app3.withTypeProvider().get(
    "/events/:eventId/attendees",
    {
      schema: {
        params: import_zod6.z.object({
          eventId: import_zod6.z.string().uuid()
        }),
        querystring: import_zod6.z.object({
          query: import_zod6.z.string().nullish(),
          pageIndex: import_zod6.z.string().nullish().default("0").transform(Number)
        }),
        response: {
          200: import_zod6.z.object({
            attendees: import_zod6.z.array(
              import_zod6.z.object({
                id: import_zod6.z.number(),
                name: import_zod6.z.string(),
                email: import_zod6.z.string().email(),
                createdAt: import_zod6.z.date(),
                checkedInAt: import_zod6.z.date().nullable()
              })
            )
          })
        }
    ...
    async (request, reply) => {
      ...
      const attendees = await prisma2.attendee.findMany({
        select: {
          id: true,
          name: true,
          email: true,
...
var app2 = (0, import_fastify2.default)();
app2.register(import_cors.default, {
  origin: "*"
});
app2.setValidatorCompiler(import_fastify_type_provider_zod2.validatorCompiler);
app2.setSerializerCompiler(import_fastify_type_provider_zod2.serializerCompiler);
app2.setErrorHandler(errorHandler);
app2.register(createEvent);
app2.register(registerForEvent);
app2.register(getEvent);
app2.register(getAttendeeBadge);
app2.register(checkIn);
app2.register(getEventAttendees);
app2.listen({ port: 3333, host: "0.0.0.0" }).then(() => {
